...
## Public Deployment
Both Backend and Frontend are deployed on AWS Fargate amd are accessible via the puplic ips http://16.171.57.241:8000/docs and http://16.170.168.155 accordingly.
