...
## Public Deployment
Both Backend and Frontend are deployed on AWS Fargate amd are accessible via the puplic ips http://51.20.135.84:8000/docs and http://13.51.167.178 accordingly.
...
- Create .env.development inside the /frontend folder with VITE_API_URL (http://51.20.135.84:8000) and VITE_S3_URL(https://ygo-cards-images-dennis2002k.s3.eu-north-1.amazonaws.com/) for the frontend to show images.
